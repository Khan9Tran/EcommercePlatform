...
public interface OrderRepository extends JpaRepository<Order, String> {
    ...
    Page<Order> findByStore_IdContainsAndOrderStatusHistories_OrderStatus_NameLikeOrIdLike(
            @Nullable String id, @Nullable String name, @Nullable String id1, Pageable pageable);
}
