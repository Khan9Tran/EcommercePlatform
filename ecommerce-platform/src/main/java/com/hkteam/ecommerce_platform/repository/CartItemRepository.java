...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
    ...
    Optional<CartItem> findByProductIdAndCartUserAndCartCartItemsAndIsCheckout(String id, User user, boolean isCheckout);
    ...
    Optional<CartItem> findByVariantIdAndCartUserAndCartCartItemsAndIsCheckout(String id, User user, boolean isCheckout);
