...
public class ProductComponentValueController {
    ...
    @PutMapping("/{id}")
    public ApiResponse<ProductComponentValueResponse> update(@PathVariable Long id, @RequestBody @Valid ProductComponentValueUpdateRequest request) {
        return  ApiResponse.<ProductComponentValueResponse>builder().result(productComponentValueService.update(id, request)).build();
